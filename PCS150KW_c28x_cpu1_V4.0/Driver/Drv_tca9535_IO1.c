...
#define GPIO_PIN_IO1_SDA                    78U
#define GPIO_CFG_IO1_SDA                    GPIO_78_GPIO78
#define GPIO_PIN_IO1_SCL                    77U
#define GPIO_CFG_IO1_SCL                    GPIO_77_GPIO77
#define GPIO_PIN_IO1_INT                    81U
#define GPIO_CFG_IO1_INT                    GPIO_81_GPIO81


static __inline void I2C_SCL_0(void)        {GPIO_writePin(GPIO_PIN_IO1_SCL, 0);}
static __inline void I2C_SCL_1(void)        {GPIO_writePin(GPIO_PIN_IO1_SCL, 1);}
static __inline void I2C_SDA_0(void)        {GPIO_writePin(GPIO_PIN_IO1_SDA, 0);}
static __inline void I2C_SDA_1(void)        {GPIO_writePin(GPIO_PIN_IO1_SDA, 1);}

static __inline void I2C_SCL_in(void)       {GPIO_setDirectionMode(GPIO_PIN_IO1_SCL, GPIO_DIR_MODE_IN);}
static __inline void I2C_SCL_out(void)      {GPIO_setDirectionMode(GPIO_PIN_IO1_SCL, GPIO_DIR_MODE_OUT);}
static __inline void I2C_SDA_in(void)       {GPIO_setDirectionMode(GPIO_PIN_IO1_SDA, GPIO_DIR_MODE_IN);}
static __inline void I2C_SDA_out(void)      {GPIO_setDirectionMode(GPIO_PIN_IO1_SDA, GPIO_DIR_MODE_OUT);}

#define I2C_SDA_READ()                      (GPIO_readPin(GPIO_PIN_IO1_SDA))   // 读SDA口线状态
#define I2C_SCL_READ()                      (GPIO_readPin(GPIO_PIN_IO1_SCL))   // 读SCL口线状态
...
static void Drv_TCA9535_IO1_PinInit(void)
{
    //控制IO设置
    GPIO_setPinConfig(GPIO_CFG_IO1_SDA);
    GPIO_setPadConfig(GPIO_PIN_IO1_SDA, GPIO_PIN_TYPE_OD);
    GPIO_setDirectionMode(GPIO_PIN_IO1_SDA, GPIO_DIR_MODE_OUT);
    GPIO_setPinConfig(GPIO_CFG_IO1_SCL);
    GPIO_setPadConfig(GPIO_PIN_IO1_SCL, GPIO_PIN_TYPE_OD);
    GPIO_setDirectionMode(GPIO_PIN_IO1_SCL, GPIO_DIR_MODE_OUT);
    //中断控制IO设置
    GPIO_setPinConfig(GPIO_CFG_IO1_INT);
    GPIO_setPadConfig(GPIO_PIN_IO1_INT, GPIO_PIN_TYPE_STD);
    GPIO_setDirectionMode(GPIO_PIN_IO1_INT, GPIO_DIR_MODE_IN);
}

static void i2c_Init(void)
{
    // 初始化I2C0引脚PINMUX
    Drv_TCA9535_IO1_PinInit();
