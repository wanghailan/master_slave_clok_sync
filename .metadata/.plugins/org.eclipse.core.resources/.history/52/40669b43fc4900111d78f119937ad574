...
static void Slave_ServicePpsCapture(bool allowSync)
{
    ...
    // 当前工程 ePWM 使用 UP-DOWN count，一个完整 PWM 周期为 2 * TBPRD。
    modulo = 2U * tbprd;
    ...
    // 实际 EPWM 相位：TBCTR + 计数方向，线性展开到 0..2*TBPRD。
