...
#define GPIO_PIN_ASel1        96U  // GPIO number for SEL1
#define GPIO_PIN_ASel2        61U  // GPIO number for SEL2
...
//    adSel_index=0;
    ...
    if((adSel_Cnt > 58)&&(adSel_Cnt < 66))//58 66
    {
        ad_ntc1[adSel_index] = DCDC_IGBT_READ_AD;//IGBT      NTC采样
    }

    if(adSel_Cnt >= 100)//100
    {
        adSel_index++;
        if(adSel_index > 2)
            adSel_index = 0;
...
/* *
 *  ADCA_SOC0  ------------ IDC_A1采样(ADC_A2)
 *  ADCA_SOC1  ------------ IDC_A2采样(ADC_A4)
 *  ADCA_SOC2  ------------ VDC_A8采样(ADC_A5)
 *  ADCA_SOC3  ------------ VDC_A9采样(ADC_A3)
 *  ADCA_SOC4  ------------ 预留(ADC_A1)
 *  */
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER0, ADC_TriggerSet, ADC_CH_ADCIN2, ADC_AcqpsSet);//采样保持窗 cycles
    ADC_setInterruptSOCTrigger(ADCA_BASE, ADC_SOC_NUMBER0, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER1, ADC_TriggerSet, ADC_CH_ADCIN4, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCA_BASE, ADC_SOC_NUMBER1, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER2, ADC_TriggerSet, ADC_CH_ADCIN5, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCA_BASE, ADC_SOC_NUMBER2, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER3, ADC_TriggerSet, ADC_CH_ADCIN3, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCA_BASE, ADC_SOC_NUMBER3, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER4, ADC_TriggerSet, ADC_CH_ADCIN1, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCA_BASE, ADC_SOC_NUMBER4, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER5, ADC_TriggerSet, ADC_CH_ADCIN2, ADC_AcqpsSet);//采样保持窗 cycles
...
//    ADC_setVREF(ADCB_BASE,ADC_REFERENCE_EXTERNAL,ADC_REFERENCE_3_3V);
    ...
    //Select the channels to convert and end of conversion flag
/* *
 *  ADCB_SOC0  ------------ IDC_A3采样(ADC_B2)
 *  ADCB_SOC1  ------------ VDC_A7采样(ADC_B4)
 *  ADCB_SOC2  ------------ VDC_A6采样(ADC_B5)
 *  ADCB_SOC3  ------------ IDC_A4采样(ADC_B3)
 *  ADCB_SOC4  ------------ 预留(ADC_B1)
 *  */
    ADC_setupSOC(ADCB_BASE, ADC_SOC_NUMBER0, ADC_TriggerSet, ADC_CH_ADCIN2, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCB_BASE, ADC_SOC_NUMBER0, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCB_BASE, ADC_SOC_NUMBER1, ADC_TriggerSet, ADC_CH_ADCIN4, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCB_BASE, ADC_SOC_NUMBER1, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCB_BASE, ADC_SOC_NUMBER2, ADC_TriggerSet, ADC_CH_ADCIN5, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCB_BASE, ADC_SOC_NUMBER2, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCB_BASE, ADC_SOC_NUMBER3, ADC_TriggerSet, ADC_CH_ADCIN3, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCB_BASE, ADC_SOC_NUMBER3, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCB_BASE, ADC_SOC_NUMBER4, ADC_TriggerSet, ADC_CH_ADCIN1, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCB_BASE, ADC_SOC_NUMBER4, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCB_BASE, ADC_SOC_NUMBER5, ADC_TriggerSet, ADC_CH_ADCIN2, ADC_AcqpsSet);
...
//    ADC_setVREF(ADCC_BASE,ADC_REFERENCE_EXTERNAL,ADC_REFERENCE_3_3V);
    ...
    //Select the channels to convert and end of conversion flag
/* *
 *  ADCC_SOC0  ------------ IDC_A5采样(ADC_C2)
 *  ADCC_SOC1  ------------ VDC_A5采样(ADC_C4)
 *  ADCC_SOC2  ------------ VDC_A4采样(ADC_C5)
 *  ADCC_SOC3  ------------ IDC_A6采样(ADC_C3)
 *  ADCC_SOC4  ------------ 预留(ADC_15)
 *  */
    ADC_setupSOC(ADCC_BASE, ADC_SOC_NUMBER0, ADC_TriggerSet, ADC_CH_ADCIN2, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCC_BASE, ADC_SOC_NUMBER0, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCC_BASE, ADC_SOC_NUMBER1, ADC_TriggerSet, ADC_CH_ADCIN4, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCC_BASE, ADC_SOC_NUMBER1, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCC_BASE, ADC_SOC_NUMBER2, ADC_TriggerSet, ADC_CH_ADCIN5, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCC_BASE, ADC_SOC_NUMBER2, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCC_BASE, ADC_SOC_NUMBER3, ADC_TriggerSet, ADC_CH_ADCIN3, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCC_BASE, ADC_SOC_NUMBER3, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCC_BASE, ADC_SOC_NUMBER4, ADC_TriggerSet, ADC_CH_ADCIN15, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCC_BASE, ADC_SOC_NUMBER4, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCC_BASE, ADC_SOC_NUMBER5, ADC_TriggerSet, ADC_CH_ADCIN2, ADC_AcqpsSet);
...
//    ADC_setVREF(ADCC_BASE,ADC_REFERENCE_EXTERNAL,ADC_REFERENCE_3_3V);
    ...
    //Select the channels to convert and end of conversion flag
/* *
 *  ADCD_SOC0  ------------ VDC_A1采样(ADC_D2)
 *  ADCD_SOC1  ------------ VDC_A2采样(ADC_D0)
 *  ADCD_SOC2  ------------ NTC2采样(ADC_D5)
 *  ADCD_SOC3  ------------ NTC1采样(ADC_D3)
 *  ADCD_SOC4  ------------ VDC_A3采样(ADC_D1)
 *  */
    ADC_setupSOC(ADCD_BASE, ADC_SOC_NUMBER0, ADC_TriggerSet, ADC_CH_ADCIN2, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCD_BASE, ADC_SOC_NUMBER0, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCD_BASE, ADC_SOC_NUMBER1, ADC_TriggerSet, ADC_CH_ADCIN0, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCD_BASE, ADC_SOC_NUMBER1, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCD_BASE, ADC_SOC_NUMBER2, ADC_TriggerSet, ADC_CH_ADCIN5, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCD_BASE, ADC_SOC_NUMBER2, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCD_BASE, ADC_SOC_NUMBER3, ADC_TriggerSet, ADC_CH_ADCIN3, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCD_BASE, ADC_SOC_NUMBER3, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCD_BASE, ADC_SOC_NUMBER4, ADC_TriggerSet, ADC_CH_ADCIN1, ADC_AcqpsSet);
    ADC_setInterruptSOCTrigger(ADCD_BASE, ADC_SOC_NUMBER4, ADC_INT_SOC_TRIGGER_NONE);
    ADC_setupSOC(ADCD_BASE, ADC_SOC_NUMBER5, ADC_TriggerSet, ADC_CH_ADCIN2, ADC_AcqpsSet);
