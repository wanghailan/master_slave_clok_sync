    ...
    switch(SCIB_RxCnt)
    {
        ...
        case 8:
            ...
            if(_rx == 0x55)
            {
                ...
                if(Igbt1_st&0x20)
                    FaultStatus.DCDC_Fault2.tbits.bMIgbt1Fault = 1;
                else
                    FaultStatus.DCDC_Fault2.tbits.bMIgbt1Fault = 0;
                if(Igbt1_st&0x10)
                    FaultStatus.DCDC_Fault2.tbits.bMIgbt2Fault = 1;
                else
                    FaultStatus.DCDC_Fault2.tbits.bMIgbt2Fault = 0;
                if(Igbt2_st&0x08)
                    FaultStatus.DCDC_Fault2.tbits.bMIgbt3Fault = 1;
                else
                    FaultStatus.DCDC_Fault2.tbits.bMIgbt3Fault = 0;
                if(Igbt2_st&0x04)
                    FaultStatus.DCDC_Fault2.tbits.bMIgbt4Fault = 1;
                else
                    FaultStatus.DCDC_Fault2.tbits.bMIgbt4Fault = 0;
            }
            break;
        default:break;
    }
