...
Ethernet_Pkt_Desc* ptpd_getPacketCallback_handler(void);

void ptpd_releaseTxPacketBuffer_handler(
        Ethernet_Handle handleApplication,
        Ethernet_Pkt_Desc *pPacket);
...
#endif
    return ptpd_getPacketCallback_handler();
}
