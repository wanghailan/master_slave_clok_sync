...
#define  ModRxTimeOut         18 //ADC中断100.0us 1.75ms是18
...
extern uint16_t   Mod1_TxBuf[Mod_TXBUF_SIZE];
extern uint16_t   Mod1_RxBuf[Mod_TXBUF_SIZE];
extern int16_t    Mod1_TxCnt;
extern int16_t    Mod1_RxCnt;

extern uint16_t   Mod2_TxBuf[Mod_TXBUF_SIZE];
extern uint16_t   Mod2_RxBuf[Mod_TXBUF_SIZE];
extern int16_t    Mod2_TxCnt;
extern int16_t    Mod2_RxCnt;
